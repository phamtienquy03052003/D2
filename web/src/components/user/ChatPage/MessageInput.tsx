...
const MessageInput: React.FC<Props> = ({ conversationId, onSend }) => {
  ...
  return (
    <div className="p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#20232b] relative">
      {showEmojiPicker && (
      ...
      <div className="flex items-center gap-2 bg-gray-100 dark:bg-[#1a1d25] rounded-full px-4 py-2 border border-transparent focus-within:border-blue-500 focus-within:bg-white dark:focus-within:bg-[#1a1d25] transition-all">
        <button
